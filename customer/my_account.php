	...
	<div class="main_wrapper">
		...
		<div id="cssmenu">
			...
			<ul>
				...
				<li><a href="\ecommerce\all_products.php">All Products</a></li>
				<li><a href="\ecommerce\customer\my_account.php">My Account</a></li>
	...
	<!-- 		<div id="form">
		...
		<div class="content_wrapper">
			...
			<div id="sidemenu">
				...
				?>
				<!-- modify-->
				<!-- <li><a href="my_account.php?ship">My Orders</a></li> -->
				<li><a href="ship.php">Shipments</a></li>	
